---
name: plugin-alt-tab-release-flow
description: Enforces correct release tagging, commit message rules, and CI triggers for plugin-alt-tab. Use this when the user asks to create or prepare a release.
---
